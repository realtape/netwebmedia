...
if (empty($parts)) {
  json_out([
    ...
    'routes' => [
      ...
      'GET  /api/predictions/contact/{id}          (predicted close-probability + reasons)',
      'GET  /api/predictions/feature-importance    (which features predict conversion best)',
      'POST /api/predictions/recompute             (retrain model from historical contacts)',
      'GET/POST /api/notifications                 (in-app notifications + create)',
      'POST /api/notifications/{id}/read           (mark notification read)',
      'POST /api/notifications/mark-all-read       (mark all unread as read)',
      'GET/POST /api/notifications/push/key        (VAPID public key)',
      ...
      'GET/POST /api/calls                         (call log + click-to-dial)',
      'PUT/DELETE /api/calls/{id}                  (update outcome / delete)',
      'POST /api/calls/twilio-status               (Twilio Voice status webhook)',
      'GET/POST /api/email-builder/templates       (block-based email templates)',
      'GET/PUT/DELETE /api/email-builder/templates/{id}  (single template + rendered html)',
