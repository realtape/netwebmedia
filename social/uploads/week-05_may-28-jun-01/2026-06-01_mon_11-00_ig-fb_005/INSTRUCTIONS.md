# 2026-06-01 MON 11:00 — IG-FB

**Week 5** · Wk5 Mon — Carousel A (brand intro)
...
5. Schedule to 2026-06-01 at 11:00 America/Santiago (CLT). MBS allows scheduling up to 75 days ahead.
...
- `a-slide-1.png` — drag this into the uploader
- `a-slide-2.png` — drag this into the uploader
- `a-slide-3.png` — drag this into the uploader
- `a-slide-4.png` — drag this into the uploader
- `a-slide-5.png` — drag this into the uploader
