...
switch ($method) {
    ...
    case 'POST':
        ...
        // Operator approval commands (OPERATOR_WHATSAPP_NUMBER replies) are detected
        // below and excluded — they must not re-trigger the auto-reply pipeline.
        ...
        // Inbound messages from OPERATOR_WHATSAPP_NUMBER are "Y 42" / "N 42" approval
        // commands from Carlos, not customer messages. Parse, act, skip auto-reply.
            ...
            if ($sender === 'them' && $opPhone) {
                try {
                    ...
                    if ($convNorm !== '' && $convNorm === $opNorm) {
                        ...
                        // "Y 42" / "yes 42" / "approve 42" -> approve
