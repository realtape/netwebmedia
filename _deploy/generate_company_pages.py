...
<div class="container">
  ...
  <div class="pitch">
    ...
    <p style="margin-top:18px;font-size:14px;opacity:.9;">Typical engagement for {niche_name}: <strong>$997/mo Growth retainer</strong> (AI Website + Social + CRM + Ads) or <strong>$497/mo Starter</strong> (social + CRM only). AI Fractional CMO from <strong>$249/mo Starter · $999/mo Growth · $2,990/mo Scale</strong>.</p>
