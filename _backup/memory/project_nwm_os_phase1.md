...
**Open flag:** outreach drafts promise "weekly Carlos calls" but V1-PLAN Tension F locked ONE boot-camp week (W6) + Isabel CS after — align drafts before sending. See [[reference_agent_names]] (Diego=sales-director, Sofia=cmo, Isabel=customer-success). Pricing ladder [[project_cmo_premium_pricing]].
