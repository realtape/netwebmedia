-- Seed conversations with test data for development
-- This migration is idempotent and runs automatically on deploy

INSERT IGNORE INTO conversations (contact_id, channel, subject, unread, created_at, updated_at)
VALUES
  (1, 'email', 'Q2 Campaign Strategy', 0, NOW(), NOW()),
  (2, 'whatsapp', NULL, 1, NOW(), NOW()),
  (3, 'email', 'Proposal Follow-up', 1, NOW(), NOW()),
  (5, 'sms', NULL, 0, NOW(), NOW()),
  (6, 'email', 'Brand Discovery Call', 0, NOW(), NOW()),
