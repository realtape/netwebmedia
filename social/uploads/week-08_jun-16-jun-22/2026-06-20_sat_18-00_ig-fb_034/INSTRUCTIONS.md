# 2026-06-20 SAT 18:00 — IG-FB

**Week 8** · Wk8 Sat — HeyGen #3 (client win EN)
...
5. Schedule to 2026-06-20 at 18:00 America/Santiago (CLT). MBS allows scheduling up to 75 days ahead.
...
- `03-client-win-en.mp4` — drag this into the uploader
