...
| JSON-LD schema | PASS | Organization, WebPage, Service with Offer for all 3 tiers ($249/$999/$2,490), BreadcrumbList, FAQPage — excellent coverage |
| Pricing accuracy | PASS | $249 / $999 / $2,490 — confirmed correct |
...
| Pricing $249/$999/$2,490 | PASS | Confirmed on pricing.html and in homepage FAQ schema |
...
```
"AEO Starter $249/mo · CMO Growth $999/mo · CMO Premium $2,490/mo. 14-day free trial, then 90-day retainer. Full AI marketing — strategy, software, and execution."
```
