# 2026-06-27 SAT 18:00 — IG-FB

**Week 9** · Wk9 Sat — HeyGen #9 (client win ES)
...
5. Schedule to 2026-06-27 at 18:00 America/Santiago (CLT). MBS allows scheduling up to 75 days ahead.
...
- `09-client-win-es.mp4` — drag this into the uploader
