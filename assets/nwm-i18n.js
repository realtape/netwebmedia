...
(function(w){
  ...
  var DICT = {
    en: {
      ...
      hero_cta1:'Get Your Free AEO Audit →', hero_cta2:'See Pricing & Packages →',
      ...
      cta_title:'See Where You\'re Leaving Revenue on the Table',
      ...
      footer_tagline:'An AI-native fractional CMO for US and LATAM SMBs. We run the strategy, build the software, and ship the campaigns — the output of a full marketing team, without the headcount.',
      // Nav (CMS sidebar)
    ...
    es: {
      ...
      hero_desc:'Haz que ChatGPT, Perplexity y Google te citen. Cierra más negocios. Un solo retainer cubre estrategia, software y ejecución completa — desde $249/mes.',
      hero_cta1:'Tu Auditoría AEO Gratis →', hero_cta2:'Ver Precios y Paquetes →',
      ...
      cta_title:'Descubre Dónde Estás Dejando Ingresos Sobre la Mesa',
      ...
      footer_tagline:'Un CMO fraccional AI-nativo para PYMEs de EE.UU. y LATAM. Diseñamos la estrategia, construimos el software y ejecutamos las campañas — el resultado de un equipo de marketing completo, sin la nómina.',
      // Nav (CMS sidebar)
