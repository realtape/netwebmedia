# 2026-06-12 FRI 11:00 — IG-FB

**Week 7** · Wk7 Fri — Carousel C (client-win, home services)
...
5. Schedule to 2026-06-12 at 11:00 America/Santiago (CLT). MBS allows scheduling up to 75 days ahead.
...
- `c-slide-1.png` — drag this into the uploader
- `c-slide-2.png` — drag this into the uploader
- `c-slide-3.png` — drag this into the uploader
- `c-slide-4.png` — drag this into the uploader
- `c-slide-5.png` — drag this into the uploader
