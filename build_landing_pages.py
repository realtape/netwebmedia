  ...
  <section class="lp-hero">
    ...
    <aside class="lp-form-card" id="plan-form">
      ...
      <form class="lp-form" action="https://netwebmedia.com/submit.php" method="POST">
        ...
        <input type="tel" name="phone" data-en-placeholder="WhatsApp number (with country code)" data-es-placeholder="WhatsApp (con código de país)" placeholder="WhatsApp number (with country code)">
