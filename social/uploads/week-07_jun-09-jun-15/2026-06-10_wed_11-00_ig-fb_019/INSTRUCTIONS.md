# 2026-06-10 WED 11:00 — IG-FB

**Week 7** · Wk7 Wed — 7-slide AEO carousel (EN)
...
5. Schedule to 2026-06-10 at 11:00 America/Santiago (CLT). MBS allows scheduling up to 75 days ahead.
...
- `aeo_en_slide_1.png` — drag this into the uploader
- `aeo_en_slide_2.png` — drag this into the uploader
- `aeo_en_slide_3.png` — drag this into the uploader
- `aeo_en_slide_4.png` — drag this into the uploader
- `aeo_en_slide_5.png` — drag this into the uploader
- `aeo_en_slide_6.png` — drag this into the uploader
- `aeo_en_slide_7.png` — drag this into the uploader
