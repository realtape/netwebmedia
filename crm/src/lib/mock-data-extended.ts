...
export const socialPosts: SocialPost[] = [
  ...
  { id: "sp6", content: "The SEO teams that adapt to AEO in 2026 will still have jobs in 2030. The ones that don't will be writing thinkpieces. Answer Engine Optimization isn't a side project — it's the new main game. → https://netwebmedia.com/blog/aeo-replaces-seo-2026.html", channels: ["Twitter", "Instagram"], status: "scheduled", scheduledFor: "2026-04-25 09:00", engagement: 0, impressions: 0, clicks: 0 },
  { id: "sp7", content: "Last-click attribution is misdirecting 30–50% of your B2B budget. It rewards what captured intent. Not what created it. If the channels getting most credit aren't showing up in your win/loss data — you have a model problem, not a data problem. → https://netwebmedia.com/blog/ai-attribution-modeling.html", channels: ["Twitter", "Instagram"], status: "scheduled", scheduledFor: "2026-04-26 09:00", engagement: 0, impressions: 0, clicks: 0 },
  { id: "sp8", content: "If your AI-generated content sounds like everyone else on your model — that's a configuration problem, not an AI problem. 60–70% of what makes brands distinctive never makes it into style guides. Fix that first. Then run the AI. → https://netwebmedia.com/blog/ai-brand-voice-enforcement.html", channels: ["Twitter", "Instagram"], status: "scheduled", scheduledFor: "2026-04-27 09:00", engagement: 0, impressions: 0, clicks: 0 },
  { id: "sp9", content: "Your competitive brief is already outdated the moment your competitor ships their next sprint. Hiring patterns reveal strategy 6–12 months in advance. You can monitor all of this for ~$100/month. → https://netwebmedia.com/blog/ai-competitive-intelligence-tools.html", channels: ["Twitter", "Instagram"], status: "scheduled", scheduledFor: "2026-04-28 09:00", engagement: 0, impressions: 0, clicks: 0 },
];
