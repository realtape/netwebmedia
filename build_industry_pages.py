...
VERTICALS = [
  ...
  },
  {
    ...
    "growth": [("Everything in CMO Lite","Todo en CMO Lite"),("Google + Meta paid ad campaigns","Campañas de anuncios pagados en Google + Meta"),("Automated lead nurture sequences","Secuencias automatizadas de nurture de leads"),("Email marketing to your contact list","Email marketing a tu lista de contactos"),("AI SDR for lead qualification &amp; booking","SDR de IA para calificación de leads y agendamiento")],
  ...
  },
  {
    ...
    "growth": [("Everything in CMO Lite","Todo en CMO Lite"),("Google Search Ads for high-intent legal keywords","Google Search Ads para keywords legales de alta intención"),("Retargeting campaigns for site visitors","Campañas de retargeting para visitantes del sitio"),("Email nurture for prospects in consideration","Email nurture para prospectos en consideración"),("AI SDR for initial inquiry screening","SDR de IA para tamizaje inicial de consultas")],
  ...
  },
  {
    ...
    "growth": [("Everything in CMO Lite","Todo en CMO Lite"),("Meta (Instagram + Facebook) visual showcase campaigns","Campañas visuales de showcase en Meta (Instagram + Facebook)"),("Automated inquiry response &amp; site visit booking","Respuesta automatizada de consultas y agendamiento de visitas"),("Pinterest + Google search campaigns for weddings","Campañas en Pinterest + Google Search para bodas"),("AI SDR for event inquiry qualification &amp; booking","SDR de IA para calificación de consultas y agendamiento")],
