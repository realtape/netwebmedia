# 2026-06-24 WED 11:00 — IG-FB

**Week 9** · Wk9 Wed — 7-slide AEO ES
...
5. Schedule to 2026-06-24 at 11:00 America/Santiago (CLT). MBS allows scheduling up to 75 days ahead.
...
- `aeo_es_slide_1.png` — drag this into the uploader
- `aeo_es_slide_2.png` — drag this into the uploader
- `aeo_es_slide_3.png` — drag this into the uploader
- `aeo_es_slide_4.png` — drag this into the uploader
- `aeo_es_slide_5.png` — drag this into the uploader
- `aeo_es_slide_6.png` — drag this into the uploader
- `aeo_es_slide_7.png` — drag this into the uploader
