# 2026-06-17 WED 11:00 — IG-FB

**Week 8** · Wk8 Wed — Carousel B re-captioned for wine niche
...
5. Schedule to 2026-06-17 at 11:00 America/Santiago (CLT). MBS allows scheduling up to 75 days ahead.
...
- `b-slide-1.png` — drag this into the uploader
- `b-slide-2.png` — drag this into the uploader
- `b-slide-3.png` — drag this into the uploader
- `b-slide-4.png` — drag this into the uploader
- `b-slide-5.png` — drag this into the uploader
