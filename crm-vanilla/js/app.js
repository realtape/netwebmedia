...
(function () {
  ...
  var I18N = {
    en: {
      ...
      nav: {
        ...
        courses: "Courses", social: "Social Planner", socialCalendar: "Social Calendar", whatsappSubs: "WhatsApp Subs", webinarSubs: "Webinar Regs", settings: "Settings"
      },
      ...
      modules: {
        ...
        conversations: {
          all: "All", email: "Email", sms: "SMS", whatsapp: "WhatsApp", chat: "Chat",
    ...
    es: {
      ...
      nav: {
        ...
        courses: "Cursos", social: "Planificador Social", socialCalendar: "Calendario Social", whatsappSubs: "Subs WhatsApp", webinarSubs: "Regs Webinar", settings: "Ajustes"
      },
      ...
      modules: {
        ...
        conversations: {
          all: "Todos", email: "Correo", sms: "SMS", whatsapp: "WhatsApp", chat: "Chat",
  ...
  var ICONS = {
    ...
    realtime: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',
    ...
    forms: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M7 8h10M7 12h10M7 16h7"/></svg>',
  ...
  var NAV_ITEMS = [
    ...
    { id: "socialCalendar", key: "socialCalendar", icon: "calendar", href: "social-launch-calendar.html" },
    { id: "whatsapp-subs", key: "whatsappSubs", icon: "whatsapp", href: "whatsapp-subs.html", adminOnly: true },
    { id: "webinar-subs", key: "webinarSubs", icon: "rocket", href: "webinar-subs.html", adminOnly: true },
  ...
  function injectLangSwitcher() {
    ...
    css.textContent =
      ...
      '#nwmLangSwitch button.on{background:#FF671F;color:#fff}' +
