...
(function (w) {
  ...
  var api = {
    ...
    // -- workflows
    wfList:    function ()            { return request('GET',    '/workflows'); },
    wfGet:     function (id)          { return request('GET',    '/workflows/' + id); },
    wfCreate:  function (payload)     { return request('POST',   '/workflows', payload); },
    wfUpdate:  function (id, payload) { return request('PUT',    '/workflows/' + id, payload); },
    wfDelete:  function (id)          { return request('DELETE', '/workflows/' + id); },
    wfRun:     function (id, ctx)     { return request('POST',   '/workflows/' + id + '/run', ctx || {}); },
    wfRuns:    function (id)          { return request('GET',    '/workflows/' + id + '/runs'); },
