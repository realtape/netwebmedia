...
SUBCATEGORIES = [
  # ── HOSPITALITY ──────────────────────────────────────────────────────────
  {
    ...
    "growth": ["Everything in AEO Starter", "Google Hotel Ads + Meta retargeting campaigns", "Automated review request sequences", "Direct booking email campaigns to past guests", "AI SDR for group bookings &amp; event inquiries"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Instagram + Facebook paid ads targeting boutique travelers", "Influencer &amp; travel blogger outreach coordination", "Seasonal promotion &amp; package campaigns", "AI SDR for partnership &amp; press inquiries"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Google + Meta ads for package promotions &amp; events", "Pre-arrival upsell email automation", "Group &amp; wedding venue promotion campaigns", "AI SDR for event &amp; corporate group inquiries"],
  ...
  # ── HEALTHCARE ───────────────────────────────────────────────────────────
  {
    ...
    "growth": ["Everything in AEO Starter", "Google Search Ads for high-intent dental keywords", "Automated recall + appointment reminder sequences", "Review generation on Google &amp; Healthgrades", "AI SDR for new patient inquiry qualification"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Google + Meta ads targeting new pet owners &amp; movers", "Automated wellness recall + birthday sequences", "Review generation on Google &amp; Yelp", "AI SDR for appointment booking inquiries"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Instagram + Facebook paid ads for consultations", "Automated treatment upsell &amp; loyalty sequences", "Review generation on Google &amp; RealSelf", "AI SDR for consultation inquiry qualification"],
  ...
  # ── BEAUTY & WELLNESS ─────────────────────────────────────────────────────
  {
    ...
    "growth": ["Everything in AEO Starter", "Instagram + Facebook paid ads for new client acquisition", "Automated rebooking + win-back sequences", "Referral program setup &amp; promotion", "AI SDR for new client inquiry qualification"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Meta + Google ads for package promotions", "Automated post-visit upsell &amp; rebooking sequences", "Gift card &amp; package campaign automation", "AI SDR for group bookings &amp; event inquiries"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Instagram + Facebook paid ads for new client acquisition", "Automated rebooking + referral reward sequences", "New barber client-building campaign", "AI SDR for appointment booking &amp; inquiries"],
  ...
  # ── PROFESSIONAL SERVICES ─────────────────────────────────────────────────
  {
    ...
    "growth": ["Everything in AEO Starter", "Google Search Ads for high-intent legal keywords", "LinkedIn authority content for partner profiles", "Automated follow-up sequences for consultation no-shows", "AI SDR for 24/7 intake qualification &amp; scheduling"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Google Search Ads targeting business owners &amp; CFO searches", "LinkedIn content marketing for partner visibility", "Email campaigns for off-season advisory service promotion", "AI SDR for consultation scheduling &amp; qualification"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "LinkedIn thought leadership + lead gen campaigns", "Google Search Ads for high-intent consulting keywords", "Email nurture sequences for long-cycle prospects", "AI SDR for discovery call scheduling"],
  ...
  # ── REAL ESTATE ──────────────────────────────────────────────────────────
  {
    ...
    "growth": ["Everything in AEO Starter", "Google + Meta listing promotion ads", "Automated lead follow-up + consultation scheduler", "Past client anniversary &amp; check-in campaigns", "AI SDR — qualifies leads &amp; books consultations 24/7"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Google + Meta ads for consumer leads &amp; agent recruitment", "Agent recruitment email campaigns", "Consumer lead nurture sequences", "AI SDR for both consumer inquiries &amp; agent recruitment"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Google + Facebook ads for owner acquisition", "Vacancy listing promotion campaigns", "Owner testimonial &amp; case study content", "AI SDR for owner inquiry qualification &amp; scheduling"],
  ...
  # ── RESTAURANTS ──────────────────────────────────────────────────────────
  {
    ...
    "growth": ["Everything in AEO Starter", "Meta + Google ads for event promotion &amp; weeknight traffic", "Automated event ticket selling sequences", "Loyalty program setup &amp; promotion", "AI SDR for private event &amp; buyout inquiries"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Google + LinkedIn ads for corporate event decision-makers", "Seasonal campaign automation (weddings, corporate, holidays)", "Automated quote follow-up sequences", "AI SDR for 24/7 inquiry qualification &amp; detail gathering"],
  ...
  # ── FITNESS ───────────────────────────────────────────────────────────────
  {
    ...
    "growth": ["Everything in AEO Starter", "Google + Meta ads for new member acquisition", "Trial-to-member conversion email sequences", "Challenge campaign promotion", "AI SDR to book free trial visits 24/7"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Instagram + Facebook ads for new student acquisition", "Intro package conversion email sequences", "Referral program setup &amp; promotion", "AI SDR for class inquiry &amp; free trial booking"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Instagram + Facebook ads for in-person &amp; online clients", "Online coaching funnel setup &amp; email sequences", "Client transformation showcase campaigns", "AI SDR for consultation booking &amp; lead qualification"],
  ...
  # ── E-COMMERCE ────────────────────────────────────────────────────────────
  {
    ...
    "growth": ["Everything in AEO Starter", "Google Shopping + Meta &amp; TikTok catalog ads", "Abandoned cart + post-purchase upsell sequences", "Loyalty program setup &amp; email automation", "AI SDR for VIP customer outreach"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Meta + Google + TikTok paid acquisition", "Post-purchase LTV optimization sequences", "Influencer &amp; UGC content coordination", "AI SDR for VIP customer &amp; wholesale outreach"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Google Shopping + Meta catalog ads for direct channel", "Post-purchase email flows for marketplace converts", "Brand launch &amp; direct channel promotion campaigns", "AI SDR for wholesale &amp; B2B inquiry qualification"],
  ...
  # ── HOME SERVICES ─────────────────────────────────────────────────────────
  {
    ...
    "growth": ["Everything in AEO Starter", "Google Local Service Ads + Meta retargeting", "Automated estimate follow-up &amp; review request sequences", "Seasonal service promotion campaigns", "AI SDR — responds to leads 24/7, books estimates"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Google Local Service Ads (Google Guaranteed)", "Seasonal maintenance campaign automation", "Review request sequences after every completed job", "AI SDR — responds to leads 24/7, books service calls"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "Google Local Service Ads + Meta ads", "Seasonal service campaign automation", "Commercial property &amp; HOA outreach sequences", "AI SDR — responds to quotes 24/7, books estimates"],
  ...
  # ── TECH & SAAS ───────────────────────────────────────────────────────────
  {
    ...
    "growth": ["Everything in AEO Starter", "Google Search + LinkedIn paid campaigns", "Trial onboarding email sequences", "Competitor comparison &amp; battle card content", "AI SDR for demo scheduling &amp; enterprise qualification"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "LinkedIn + Google ads for early customer acquisition", "Product Hunt &amp; launch platform coordination", "Email sequences for beta users and early adopters", "AI SDR for demo scheduling &amp; partnership outreach"],
  ...
  },
  {
    ...
    "growth": ["Everything in AEO Starter", "LinkedIn + Google ads for agency new business", "Outbound sequences for ideal client acquisition", "Case study &amp; social proof content production", "AI SDR for new business inquiry qualification"],
...
{grow_lis}
      ...
      <div class="price-card">
        ...
        <div class="price-amount">$2,490<span data-en="/mo" data-es="/mes">/mo</span></div>
